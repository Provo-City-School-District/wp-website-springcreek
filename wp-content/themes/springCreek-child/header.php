...
<html <?php language_attributes();?>>
	<head>
		<!-- Global site tag (gtag.js) - Google Analytics -->
			<script async src="https://www.googletagmanager.com/gtag/js?id=UA-130781213-5"></script>
			<script>
			  window.dataLayer = window.dataLayer || [];
			  function gtag(){dataLayer.push(arguments);}
			  gtag('js', new Date());
			
			  gtag('config', 'UA-130781213-5');
			</script>
	...
	<body>
		...
		<header id="mainHeader">
			...
			<h1>Spring Creek Elementary School</h1>
			</a>
				<aside>
					<ul class="sociallinks">
						<li><a href="http://www.instagram.com/springcreekprovo/"><img src="<?php echo get_template_directory_uri() .'/assets/icons/socialmedia-instagram-white.svg' ?>" alt="Link to Instagram" /></span>
							</a>
						</li>
						<li><a href="https://twitter.com/@SpringCreekPCSD"><img src="<?php echo get_template_directory_uri() .'/assets/icons/socialmedia-twitter-white.svg' ?>" alt="Link to Twitter" /></span>
							</a>
						</li>
						<li><a href="http://www.facebook.com/springcreekelementary"><img src="<?php echo get_template_directory_uri() .'/assets/icons/socialmedia-facebook-white.svg' ?>" alt="Link to Facebook" /></span>
							</a>
						</li>
					</ul>
					<!-- Search Form -->
					...
					<ul class="contactinfo" itemscope itemtype="https://schema.org/PostalAddress">
						<li><span itemprop="streetAddress">1740 South Nevada Ave</span><span itemprop="addressLocality"> Provo</span>, <span itemprop="addressRegion">Utah</span> <span itemprop="postalCode">84606</span><span class="phone" itemprop="telephone"> Phone: (801) 370-4650</span><span class="fax" itemprop="faxNumber"> Fax: (801) 370-4653</span>
					</ul>
